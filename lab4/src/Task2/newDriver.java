	...
	while(true)
	{
		...
		if (input == 1) {
			while (true) {
				...
				BufferedWriter bw = new BufferedWriter(new FileWriter("C:\\Users\\user\\Desktop\\admin.out"));
				...
				while (true) {
					...
					if (answer == 1) {
						...
						i.add(instructor);
						ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("C:\\Users\\user\\Desktop\\instructor.out"));
						oos.writeObject(i);
	                    oos.flush();
	                    oos.close();
						bw.newLine();
					...
					if (answer == 2) {
						...
						ObjectOutputStream oost = new ObjectOutputStream(new FileOutputStream("C:\\Users\\user\\Desktop\\book.out"));
						System.out.println("Please, fill the following ...");
						scanner.nextLine();
						...
						Textbook textbook = new Textbook(author, title, isbn);
					...
					if (answer == 3) {
						ObjectOutputStream ooss = new ObjectOutputStream(new FileOutputStream("C:\\Users\\user\\Desktop\\course.out"));
						System.out.println("Please, enter next fields : course title, Instructor, Textbook");
						scanner.nextLine();
						System.out.printf("Write course title: ");
						String courseTitle = scanner.nextLine();
						ObjectOutputStream oos1 = new ObjectOutputStream(new FileOutputStream("C:\\Users\\user\\Desktop\\instructor.out"));
						...
						ObjectOutputStream oos2 = new ObjectOutputStream(new FileOutputStream("C:\\Users\\user\\Desktop\\book.out"));
						...
						bw.flush();
						bw.newLine();
						Textbook txtbook = new Textbook(author1,title1,isbn1);
		...
		if (input == 2) {
			while (true) {
				...
				if (cnt == 1) {
					...
					ObjectInputStream ois = new ObjectInputStream(new FileInputStream("C:\\Users\\user\\Desktop\\course.out"));
				...
				if (cnt == 2) {
					...
					ObjectInputStream ois1 = new ObjectInputStream(new FileInputStream("C:\\Users\\user\\Desktop\\course.out"));
